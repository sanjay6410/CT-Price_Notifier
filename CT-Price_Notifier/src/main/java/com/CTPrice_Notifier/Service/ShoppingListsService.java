...
public interface ShoppingListsService {
	...
	String updateShoppingListChangePercentageNumber(String customerId, String lineItemId, int percentageNumber);

	String customerShoppingListsExists(String customerId);
